...
@section('conten')
    ...
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.2/css/all.css" integrity="sha384-oS3vJWv+0UjzBfQzYUhtDYW+Pj2yciDJxpsK1OYPAYjqT085Qq/1cq5FLXAZQ7Ay" crossorigin="anonymous">
    <link rel="stylesheet" href="http://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css">
    <link rel="stylesheet" type="text/css" href="source/css/dangnhap.css">
      ...
      <div class="formdangnhap col-md-8 col-md-offset-2 col-xs-12 col-sm-10 ">
          <div><img src="anh/logo.png" alt="" class="img-rounded" style="width: 130px;height:"></div>
            <h2 style="margin-top: 10px; color: #555">ĐĂNG NHẬP</h2>
              ...
              <form>
              <input type="email" class="form-control" id="inputEmail" placeholder="Email" style="margin-top: 10px;height: 50px">
          

              <input type="password" class="form-control" id="inputPassword" placeholder="Password" style="width: 100%; margin-top:20px;height: 50px">
