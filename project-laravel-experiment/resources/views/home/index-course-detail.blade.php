...
<head>
	...
	<link href="{{asset('css/chi-tiet.css') }}" rel="stylesheet">
	<link href="{{asset('css/saaa.css') }}" rel="stylesheet">
	<link href="{{asset('css/wedcss.css') }}" rel="stylesheet">
	...
	@include('home.header')  	
		   <div class="top-dad container-fluid" style="font-family: inherit">
				<header class="container top " style="">
					...
					<div class="anh-dai-dien col-xs-12 ">
