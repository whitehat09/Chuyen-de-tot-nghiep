              ...
              <div class="form-group">
                  ...
                  <input value="{{$category->title}}" placeholder="Nhập tiêu đề tại đây" title=""
                                   type="text" class="form-control" name="title"/>
                                    <textarea placeholder="Description" class="form-control" style="height:100px" name="description" cols="50" rows="10" name="description" value={{$category->description}} ></textarea>
