...
<body>
  ...
  <div style="min-height: calc(100vh - 377.5px);">
    ...
    @include('fontend.header')
        ...
        <div>
     <!-- nội dung -->
    <div style="background-color: #fddded;">
         <div class="container">
            <div class="menu-new hidden-xs">
                                                                                    <ul class="menu">
                                                                                                    <li>
                                                        <a href="/course/ngoai-ngu">Ngoại ngữ</a>
                                                                                                                    <div class="megadrop">
                                                                <div class="col">
                                                                    <ul>
                                                                        <li>
                                                                            <a href="/course/ngoai-ngu">Tất cả Ngoại ngữ</a>
                                                                        </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/tieng-han">Tiếng Hàn</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/tieng-anh">Tiếng Anh</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/tieng-trung">Tiếng Trung</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/tieng-nhat">Tiếng Nhật</a>
                                                                                                    ...
                                                                                                    <li>
                                                        <a href="/course/marketing">Marketing</a>
                                                                                                                    <div class="megadrop">
                                                                <div class="col">
                                                                    <ul>
                                                                        <li>
                                                                            <a href="/course/marketing">Tất cả Marketing</a>
                                                                        </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/facebook-marketing">Facebook Marketing</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/email-marketing">Email Marketing</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/google-adwords">Google Ads</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                ...
                                                                                <a href="/tag/content-marketing">Content marketing</a>
                                                                                                                                                    ...
                                                                                                                                                    <li>
                                                                                <a href="/tag/social-viral-marketing">Social &amp; Viral Marketing</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/branding-thuong-hieu">Branding, thương hiệu</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/affiliate">Affiliate</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/video-marketing">Video marketing</a>
                                                                            </li>
                                                                                                                                            </ul>
                                                                </div>
                                                            </div>
                                                                                                    ...
                                                                                                    <li>
                                                        <a href="/course/tin-hoc-van-phong">Tin học văn phòng</a>
                                                                                                                    <div class="megadrop">
                                                                <div class="col">
                                                                    <ul>
                                                                        <li>
                                                                            <a href="/course/tin-hoc-van-phong">Tất cả Tin học văn phòng</a>
                                                                        </li>
                                                                                                                                                    <li>
                                                                                ...
                                                                                <a href="/tag/powerpoint">PowerPoint</a>
                                                                                                    ...
                                                                                                    <li>
                                                        <a href="/course/thiet-ke">Thiết kế</a>
                                                                                                                    <div class="megadrop">
                                                                <div class="col">
                                                                    <ul>
                                                                        <li>
                                                                            <a href="/course/thiet-ke">Tất cả Thiết kế</a>
                                                                        </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/phan-mem-thiet-ke">Phần mềm thiết kế</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/thiet-ke-web">Thiết kế web</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/thiet-ke-do-hoa">Thiết kế đồ họa</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/thiet-ke-noi-that">Thiết kế nội thất</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/thiet-ke-kien-truc">Thiết Kế Kiến Trúc</a>
                                                                            </li>
                                                                                                                                            </ul>
                                                                </div>
                                                            </div>
                                                                                                    ...
                                                                                                    <li>
                                                        <a href="/course/kinh-doanh-khoi-nghiep">Kinh doanh - Khởi nghiệp</a>
                                                                                                                    <div class="megadrop">
                                                                <div class="col">
                                                                    <ul>
                                                                        <li>
                                                                            <a href="/course/kinh-doanh-khoi-nghiep">Tất cả Kinh doanh - Khởi nghiệp</a>
                                                                        </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/chien-luoc-kinh-doanh">Chiến lược kinh doanh</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/bat-dong-san">Bất động sản</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/crypto">Crypto</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/kinh-doanh-online">Kinh doanh online</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/kinh-doanh">Kinh doanh</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/khoi-nghiep">Khởi nghiệp</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/startup">Startup</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/kiem-tien-online">Kiếm tiền online</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/lam-giau-tai-chinh-ca-nhan">Làm giàu &amp; Tài chính cá nhân</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/ban-le-dich-vu">Bán lẻ - Dịch vụ</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/chung-khoan">Chứng khoán</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/dau-tu">Đầu tư</a>
                                                                                                    ...
                                                                                                    <li>
                                                        <a href="/course/phat-trien-ca-nhan">Phát triển cá nhân</a>
                                                                                                                    <div class="megadrop">
                                                                <div class="col">
                                                                    <ul>
                                                                        <li>
                                                                            <a href="/course/phat-trien-ca-nhan">Tất cả Phát triển cá nhân</a>
                                                                        </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/tai-chinh-ca-nhan">Tài chính cá nhân</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/ky-nang-lanh-dao">Kỹ năng lãnh đạo</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/tang-hieu-qua-cong-viec">Tăng hiệu quả công việc</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/ren-luyen-tri-nho">Rèn luyện trí nhớ</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/thuyet-trinh">thuyết trình</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/ky-nang-giao-tiep">Kỹ năng giao tiếp</a>
                                                                            </li>
                                                                                                                                            </ul>
                                                                </div>
                                                            </div>
                                                                                                    ...
                                                                                                    <li>
                                                        <a href="/course/sale-ban-hang">Sale, bán hàng</a>
                                                                                                                    <div class="megadrop">
                                                                <div class="col">
                                                                    <ul>
                                                                        <li>
                                                                            <a href="/course/sale-ban-hang">Tất cả Sale, bán hàng</a>
                                                                        </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/ban-hang-online">Bán hàng online</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/livestream">Livestream</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/kich-ban-ban-hang">Kịch bản bán hàng</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/ky-nang-telesale">Kỹ năng telesale</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/ky-nang-chot-sale">Kỹ năng chốt sale</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/ky-nang-ban-hang">Kỹ năng bán hàng</a>
                                                                            </li>
                                                                                                                                            </ul>
                                                                </div>
                                                            </div>
                                                                                                    ...
                                                                                                    <li>
                                                        <a href="/course/cong-nghe-thong-tin">Công nghệ thông tin</a>
                                                                                                                    <div class="megadrop">
                                                                <div class="col">
                                                                    <ul>
                                                                        <li>
                                                                            <a href="/course/cong-nghe-thong-tin">Tất cả Công nghệ thông tin</a>
                                                                        </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/lap-trinh">Lập trình</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/lap-trinh-web">Lập trình web</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/lap-trinh-android">lập trình android</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/lap-trinh-ios">lập trình ios</a>
                                                                            </li>
                                                                                                                                            </ul>
                                                                </div>
                                                            </div>
                                                                                                    ...
                                                                                                    <li>
                                                        <a href="/course/suc-khoe-gioi-tinh">Sức khỏe - Giới tính</a>
                                                                                                                    <div class="megadrop">
                                                                <div class="col">
                                                                    <ul>
                                                                        <li>
                                                                            <a href="/course/suc-khoe-gioi-tinh">Tất cả Sức khỏe - Giới tính</a>
                                                                        </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/suc-khoe">Sức khoẻ</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/giam-can">giảm cân</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/suc-khoe-tinh-than">Sức khỏe tinh thần</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/thien">Thiền</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/nghe-thuat-quyen-ru">Nghệ thuật quyến rũ</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/giam-stress">Giảm stress</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/fitness-giam-can">Fitness - Giảm cân</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/tinh-yeu">Tình yêu</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                ...
                                                                                <a href="/tag/massage">Massage</a>
                                                                                                                                                    ...
                                                                                                                                                    <li>
                                                                                <a href="/tag/dinh-duong">Dinh dưỡng</a>
                                                                            </li>
                                                                                                                                            </ul>
                                                                </div>
                                                            </div>
                                                                                                    ...
                                                                                                    <li>
                                                        <a href="/course/phong-cach-song">Phong cách sống</a>
                                                                                                                    <div class="megadrop">
                                                                <div class="col">
                                                                    <ul>
                                                                        <li>
                                                                            <a href="/course/phong-cach-song">Tất cả Phong cách sống</a>
                                                                        </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/am-thuc">Ẩm Thực</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/guitar">Guitar</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/piano">Piano</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/lam-dep">Làm đẹp</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/handmade">Handmade</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/ao-thuat">Ảo thuật</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/am-nhac">Âm nhạc</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/am-thuc-nau-an">Ẩm thực - Nấu ăn</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/dance-zumba">Dance - Zumba</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/phong-thuy">Phong thuỷ</a>
                                                                            </li>
                                                                                                                                            </ul>
                                                                </div>
                                                            </div>
                                                                                                    ...
                                                                                                    <li>
                                                        <a href="/course/nuoi-day-con">Nuôi dạy con </a>
                                                                                                                    <div class="megadrop">
                                                                <div class="col">
                                                                    <ul>
                                                                        <li>
                                                                            <a href="/course/nuoi-day-con">Tất cả Nuôi dạy con </a>
                                                                        </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/giao-duc-som">Giáo dục sớm</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/thai-giao">Thai giáo</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/ky-nang-mem-cho-con">Kỹ năng mềm cho con</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/an-dam">Ăn dặm</a>
                                                                            </li>
                                                                                                                                            </ul>
                                                                </div>
                                                            </div>
                                                                                                    ...
                                                                                                    <li>
                                                        <a href="/course/hon-nhan-gia-dinh">Hôn nhân &amp; Gia đình</a>
                                                                                                                    <div class="megadrop">
                                                                <div class="col">
                                                                    <ul>
                                                                        <li>
                                                                            <a href="/course/hon-nhan-gia-dinh">Tất cả Hôn nhân &amp; Gia đình</a>
                                                                        </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/hon-nhan">Hôn nhân</a>
                                                                            </li>
                                                                                                                                            </ul>
                                                                </div>
                                                            </div>
                                                                                                    ...
                                                                                                    <li>
                                                        <a href="/course/nhiep-anh-dung-phim">Nhiếp ảnh, dựng phim</a>
                                                                                                                    <div class="megadrop">
                                                                <div class="col">
                                                                    <ul>
                                                                        <li>
                                                                            <a href="/course/nhiep-anh-dung-phim">Tất cả Nhiếp ảnh, dựng phim</a>
                                                                        </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/kien-thuc-nhiep-anh">Kiến thức nhiếp ảnh</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/bien-tap-video">Biên tập video</a>
                                                                            </li>
                                                                                                                                                    <li>
                                                                                <a href="/tag/cong-cu-chinh-sua-anh">Công cụ chỉnh sửa ảnh</a>
                                                                            </li>
                                                                                                                                            </ul>
                                                                </div>
                                                            </div>
            ...
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                        <div class="item active">
                            <img style="float: right;"  src="https://unica.vn/upload/images/89025629_lam-ban-voi-con_thumb.png" alt="...">
                            <div class="carousel-caption">
                                ...
                            </div>
                        </div>
                        <div class="item">
                            <img style="float: right;"  src="https://unica.vn/upload/images/90030028_de-cuoc-song-hon-nhan-luon-ngot-ngao_thumb.png" alt="...">
                            <div class="carousel-caption">
                            ...
                            </div>
                        </div>
